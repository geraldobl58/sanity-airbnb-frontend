    ...
    <div className="container">
      ...
      <div className="section">
        <div className="information">
          <h1><b>{propertyType} hosted by {host?.name}</b></h1>
          <h4>{bedrooms} bedroom{isMultiple(bedrooms)} * {beds} bed{isMultiple(beds)}</h4>
          <hr />
          <h4><b>Enhanced Clean</b></h4>
          <p>This host is committed to 5step enhanced cleaning process</p>
          <h4><b>Amenities for everyday living</b></h4>
          <p>The host has equipped this place for long stays - kitchen, shampoo, conditioner, hair</p>
